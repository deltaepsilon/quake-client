...
angular.module('quiverApp')
  .factory('stripeService', function ($q, $http, $resource, $rootScope) {
    ...
    var getResource = function () {
      ...
      return $resource($rootScope.quake.root + '/subscription/create', {});
    };
    ...
    return {
      ...
      createQuiverSubscription: function (id, card) {
        var deferred = $q.defer();
        this.createCustomer(card).then(function (customer) {
          var subscription = getResource().save({planID: id, customer: customer});
